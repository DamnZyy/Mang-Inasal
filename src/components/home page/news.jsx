...
const cardData = [
  {
    id: 1,
    image: News1,
    content: 'LOOK: Mang Inasal Menu and Prices as of July 2024',
    date: 'Posted on 01 Jul 2024'
  },
  {
    id: 2,
    image: News2,
    content: 'Maris and Anthony say ‘yes’ to Mang Inasal as Pork BBQ endorsers',
    date: 'Posted on 29 Jun 2024'
  },
  {
    id: 3,
    image: News3,
    content: 'Mang Inasal delights international guests with Ihaw-Sarap treats in the 1st UN Tourism Forum',
    date: 'Posted on 27 Jun 2024'
  },
  {
    id: 4,
    image: News4,
    content: 'Dads deserve a feast at Mang Inasal this Father’s Day',
    date: 'Posted on 07 Jun 2024'
  },
  {
    id: 5,
    image: News5,
    content: 'Mang Inasal launches ‘AlmuSOLB’ breakfast meals in select branches',
    date: 'Posted on 07 Jun 2024'
  }
];
...
export default function News() {
  ...
  return (
    <section className='bg-[#faf5ee] max-w-[1500px] m-auto'>
        <div class="mx-auto max-w-[1240px] px-4 py-12">
          <div class="max-w-7xl m-auto items-center justify-between sm:flex">
              <div className="flex flex-col">
                <h2 class="text-[#2d9751] font-bold text-[40px] tracking-tight">News</h2>
            ...
            <div class="mt-8">
                <div ref={sliderRef} class="keen-slider">
                  {cardData.map((data, index) => <NewsSlider image={data.image} key={index} content={data.content} data={data.date} />)}
                </div>
            </div>
        </div>
    </section>
